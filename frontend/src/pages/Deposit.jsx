  ...
  async function handleDeposit(e) {
    ...
    try {
      ...
      if (!connectedAccounts || connectedAccounts.length === 0) {
        throw new Error('No connected Pera account found. Please connect your wallet first.')
      }
      if (connectedAccounts[0] !== state.address) {
        throw new Error('Connected wallet account does not match the selected sender address. Reconnect Pera to the correct account.')
      }
