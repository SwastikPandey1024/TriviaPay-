...
export default function ScanPay() {
  ...
  async function handlePay(e) {
    ...
    try {
      ...
      if (!connectedAccounts || connectedAccounts.length === 0) throw new Error('No connected wallet account. Please connect Pera Wallet first.')
      if (connectedAccounts[0] !== state.address) throw new Error('Connected Pera account does not match your selected sender address.')
